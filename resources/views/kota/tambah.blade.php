...
<div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('kota.simpan') }}">
                        {{ csrf_field() }}
                      <div class="form-group {{ $errors->has('namakota') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="namakota" required="required" class="form-control col-md-7 col-xs-12" name="namakota" value="{{ old('namakota') }}" autofocus>
                        </div>
                      ...
                      <div class="form-group {{ $errors->has('kd_kota') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="kd_kota" required="required" class="form-control col-md-7 col-xs-12" name="kd_kota" value="{{ old('kd_kota') }}" autofocus>
                        </div>
