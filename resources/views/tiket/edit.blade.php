  ...
  <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      <br />
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('tiket.update',['id' => $tiket->id]) }}">
                          {{ csrf_field() }}
                        <div class="form-group {{ $errors->has('unit') ? ' has-error' : '' }}">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="unit"> Kode Unit <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="unit" required="required" class="form-control col-md-7 col-xs-12" name="unit" value="{{ old('unit') ? old('unit') : $tiket->unit }}">
                          </div>
                          @if ($errors->has('unit'))
                        ...
                        <div class="form-group {{ $errors->has('date') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input id="date" type="date" class="form-control "  name="date" value="{{ old('date') ? old('date') : $tiket->date }}" min="{{ date('Y-m-d')}}">
                          </div>
                          @if ($errors->has('date'))
                              <span class="help-block">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control selectpicker" name="from" data-live-search="true" id="from">
                              ...
                              @foreach ($kota as $Kota)
                                <option value="{{ $Kota->namakota }}"  @if ($tiket->from == $Kota->namakota)
                                  {{ "selected" }}
                        ...
                        <div class="form-group {{ $errors->has('to') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control selectpicker" name="to" data-live-search="true" id="to">
                              ...
                              @foreach ($kota as $Kota)
                                <option value="{{ $Kota->namakota }}"  @if ($tiket->to == $Kota->namakota)
                                  {{ "selected" }}
                                @endif>{{$Kota->namakota }} {{ $Kota->kd_kota }}</option>
                              @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('departure') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              <input id="departure" type='time' name="departure" value="{{ old('departure') ? old('departure') : $tiket->departure}}" class="form-control" />
                          </div>
                        ...
                        <div class="form-group {{ $errors->has('arrival') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                              <input id="arrival" type='time' name="arrival" value="{{ old('arrival') ? old('arrival') : $tiket->arrival }}" class="form-control" />
                          </div>
                        ...
                        <div class="form-group {{ $errors->has('amount') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" id="amount" required="required" class="form-control col-md-7 col-xs-12" name="amount" value="{{ old('amount') ? old('amount') : $tiket->amount}}">
                          </div>
                        ...
                        <div class="form-group {{ $errors->has('cost') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" id="cost" required="required" class="form-control col-md-7 col-xs-12" name="cost" value="{{ old('cost') ? old('cost') : $tiket->cost }}">
                          </div>
                          @if ($errors->has('cost'))
                              <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('kategori_id') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control selectpicker" name="kategori_id" data-live-search="true" id="kategori_id">
                              <option value="">-- Pilih Kategori --</option>
                              @foreach ($kategori as $Kategori)
                                <option value="{{ $Kategori->id }}" @if ($Kategori->id == $tiket->kategori_id)
                                  {{ "selected" }}
