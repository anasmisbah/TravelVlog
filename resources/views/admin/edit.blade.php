  ...
  <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      <br />
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('admin.update',['id' => $admin->id]) }}" enctype="multipart/form-data">
                          {{ csrf_field() }}
                        <div class="form-group {{ $errors->has('username') ? ' has-error' : '' }}">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="username"> username <span class="required">*</span>
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="username" required="required" class="form-control col-md-7 col-xs-12" name="username" value="{{old('username') ? old('username') :$admin->user->username}}">
                          </div>
                        ...
                        <div class="form-group {{ $errors->has('nama') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="nama" required="required" class="form-control col-md-7 col-xs-12" name="nama" value="{{old('nama') ? old('nama') : $admin->nama }}">
                          </div>
                          @if ($errors->has('nama'))
                              <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control selectpicker" name="gender" data-live-search="true">
                              ...
                              <option value="female" id="female" @if ($admin->gender == "female")
                                {{"selected"}}
                              @endif>Female</option>
                              <option value="male" id="male" @if ($admin->gender == "male")
                                {{"selected"}}
                              @endif>Male</option>
                              <option value="other" id="male" @if ($admin->gender == "other")
                                {{"selected"}}
                              @endif>Other</option>
                            </select>
                          </div>
                        ...
                        <div class="form-group {{ $errors->has('tgllahir') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="date" class="form-control "  name="tgllahir" value="{{old('tgllahir') ? old('tgllahir') : $admin->tgllahir}}" max="{{ date('Y-m-d')}}">
                          </div>
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="email" id="email" required="required" class="form-control col-md-7 col-xs-12" name="email" value="{{old('email') ? old('email') : $admin->user->email}}">
                          </div>
                          @if ($errors->has('email'))
                              <span class="help-block">
                        ...
                        <div class="form-group {{ $errors->has('no_identitas') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="no_identitas" required="required" class="form-control col-md-7 col-xs-12" name="no_identitas" value="{{old('no_identitas') ? old('no_identitas') : $admin->no_identitas}}">
                          </div>
                        ...
                        <div class="form-group {{ $errors->has('notlp') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="notlp" required="required" class="form-control col-md-7 col-xs-12" name="notlp" value="{{old('notlp') ? old('notlp') : $admin->notlp}}">
                          </div>
                          @if ($errors->has('notlp'))
                              <span class="help-block">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="alamat" name="alamat" class="form-control" rows="3" placeholder="Alamat">{{old('alamat') ? old('alamat') : $admin->alamat}}</textarea>
                        </div>
